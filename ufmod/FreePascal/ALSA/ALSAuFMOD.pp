{ *** uFMOD (ALSA) unit for FreePascal *** }
...
{  function uFMOD_ALSAPlaySong(
  ...
  Return Values:
  ---
     On success, returns an ALSA output device handle. Returns nil on
...
function uFMOD_ALSAPlaySong(lpXM:Pointer;param,fdwSong:LongWord;szPCM_dev:AnsiString):Pointer; cdecl; external name 'uFMOD_ALSAPlaySong';
