...
{ Linking to cmem is required in order to overcome a weird FPC bug:
  *** Inconsistency detected by ld.so: dl-minimal.c: ... }
uses cmem, OpenAL;
...
function uFMOD_OALPlaySong(lpXM:Pointer;param,fdwSong,source:LongWord):LongWord; cdecl; external name 'uFMOD_OALPlaySong';
